  ...
  return (
    <div className="relative min-h-screen text-white overflow-hidden w-full">
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
            ...
            <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              <div>
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  ...
                  <Link href="/leagues" className="rounded-xl border border-cyan-400/20 bg-cyan-400/10 px-5 py-3 font-semibold text-cyan-200 hover:bg-cyan-400/15 transition-all">
                    View Leagues
                  </Link>
                </div>
              </div>
        ...
        {/* ═══ 5. HOW IT WORKS ═══ */}
        <section className="w-full max-w-6xl mx-auto px-6 py-16 text-center">
          <motion.h2 className="text-3xl sm:text-4xl font-black mb-4">
            How It Works
          </motion.h2>
